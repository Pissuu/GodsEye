...
def generate(name,f):
    ...
    import shutil
    newPath= shutil.copy('C:/Users/Jairaj Pisupati/PycharmProjects/GodsEye/output/'+name+'_Output_'+str(f)+'.mp4','C:/Users/Jairaj Pisupati/PycharmProjects/GodsEye/api/media/output')
