...
protoFile = "C:/Users/Jairaj Pisupati/PycharmProjects/GodsEye/multipose_model/pose_deploy_linevec.prototxt"
weightsFile = "C:/Users/Jairaj Pisupati/PycharmProjects/GodsEye/multipose_model/pose_iter_440000.caffemodel"
...
def alpha(name,f):
    ...
    video_name = name
    cap = cv2.VideoCapture('C:/Users/Jairaj Pisupati/PycharmProjects/GodsEye/api/media/videos/' + video_name)
    ...
    import sys
    sys.path.insert(0, 'C:/Users/Jairaj Pisupati/PycharmProjects/GodsEye/output')
