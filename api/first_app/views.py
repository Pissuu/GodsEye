...
def PhotoGrid(request):
    ...
    import os
    filelist = os.listdir('C:/Users/Jairaj Pisupati/PycharmProjects/GodsEye/api/media/output_frames')
...
def Vout(request):
    ...
    if request.POST:
        ...
        if form1.is_valid():
            ...
            ffname=fname[0]
            import sys
            sys.path.insert(0,'C:/Users/Jairaj Pisupati/PycharmProjects/GodsEye')
            from main_test import alpha
            print(ffname)
            pathh='C:/Users/Jairaj Pisupati/PycharmProjects/GodsEye/api/media/output/'+ffname+'_Output_'+str(f)+'.mp4'
            context = {
            ...
            if (os.path.exists(pathh)==False):
                ...
                file_list1 = os.listdir('C:/Users/Jairaj Pisupati/PycharmProjects/GodsEye/api/media/output_frames')
    ...
    if form.is_valid():
        if request.FILES:
            for filename, file in request.FILES.items():
                ...
                path = 'C:/Users/Jairaj Pisupati/PycharmProjects/GodsEye/api/media/videos/'+name
